...
print( "Hello",name, "! Your ability to", superpower, "will make sure you never have to look at ", enemy, "again. Go eat " ,food, " as you walk down the streets of ", liveIn , "and use ", superpower , "for good and not evil!")